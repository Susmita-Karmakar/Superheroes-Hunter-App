...
function getSearchedSuperHeroes() {
        ...
        <h3 class = "loading-and-error-font"> Loading Super Heroes .... </h3>`;
        ...
        apiRequest.onreadystatechange = function () {
                ...
                if (this.readyState == 4 && this.status == 200) {
                        ...
                        if (data.response === "error") {
                                displaySearchedHeroesResult.innerHTML = '<h3 class = "loading-and-error-font"> Oops ! There is no super hero with such name, please try again.. </h3> ';
                                return;
                        }
                        ...
                        for (let hero of data.results) {
                                ...
                                if (arr.includes(hero.id)) {
                                        favButton.style.color = '#FF5722';
                                        favButton.style.backgroundColor = "white";
                                        favButton.style.border = '3px solid #FF5722'
